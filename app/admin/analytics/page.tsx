...
export default async function AdminAnalyticsPage() {
  ...
  return (
    <Suspense
      fallback={<div className="text-white/40">Loading analytics...</div>}
    >
      <AnalyticsContent />
    </Suspense>
  );
              ...
              return (
                ...
                >
                  <div className="text-xs text-white/50 font-mono">
                    ₹{Math.floor(m.total_pool_gbp / 100000)}L
                  </div>
                  <div
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                value: `₹${(stats?.total_charity_raised ?? 0).toLocaleString("en-IN")}`,
              },
              {
                label: "Current Prize Pool",
                value: `₹${(stats?.current_prize_pool ?? 0).toLocaleString("en-IN")}`,
              },
              { label: "Draws Run", value: stats?.total_draws_run ?? 0 },
              {
                label: "Pending Winner Reviews",
