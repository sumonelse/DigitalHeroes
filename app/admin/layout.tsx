...
async function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-void">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="text-xs font-bold text-void bg-violet px-2 py-0.5 rounded-md uppercase tracking-wider">
                  Admin
                </span>
              ...
              <div className="text-xs text-white/30">
                Digital Heroes Platform Management
              </div>
            </div>
          </div>
          <div className="text-xs text-white/30">
            Signed in as{" "}
            <span className="text-violet font-semibold">{profile.email}</span>
          </div>
        </div>
      ...
      <main className="max-w-[1600px] mx-auto p-6 md:p-8">{children}</main>
    </div>
  );
}
