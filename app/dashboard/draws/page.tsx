...
export default async function DrawsPage() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="font-display text-3xl md:text-4xl font-bold text-white">Monthly Draw</h1>
        <p className="text-white/40 mt-1">Enter your 5 Stableford scores and compete for the prize pool.</p>
      </div>
      <DrawEntry
        draw={drawData.draw}
