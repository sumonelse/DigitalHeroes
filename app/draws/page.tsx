        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-white/50 text-lg max-w-xl mx-auto">
              View past draw results and see who won. Every month, 5 numbers are
              drawn from all eligible entries.
            </p>
          </div>
                      ...
                      <div className="flex gap-6 text-sm">
                        <div className="text-center">
                          <div className="font-display text-xl font-bold text-gold">
                            ₹
                            {Math.floor(
                              draw.prize_pools.jackpot_pool_gbp,
                            ).toLocaleString("en-IN")}
                          </div>
                          <div className="text-white/40">Jackpot</div>
                        </div>
                        <div className="text-center">
                          <div className="font-display text-xl font-bold text-emerald">
                            ₹
                            {Math.floor(
                              draw.prize_pools.match4_pool_gbp,
                            ).toLocaleString("en-IN")}
                          </div>
                          <div className="text-white/40">4 Match</div>
                        </div>
                        <div className="text-center">
                          <div className="font-display text-xl font-bold text-sapphire">
                            ₹
                            {Math.floor(
                              draw.prize_pools.match3_pool_gbp,
                            ).toLocaleString("en-IN")}
                          </div>
